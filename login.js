...
function createTempPosts(){
    ...
    post.comment.push(["Nice!"]);
    post.commentname.push([users[0].name]);
    post.commentpic.push(["../MCO1/profile2.png"]);
    post.userid = 0;
    post.commentID.push([0,0,0]);
    post.commentuserID.push([0]);

    post.comment[0].push(["Cool!"]);
    post.commentname[0].push([users[1].name]);
    post.commentpic[0].push(["../MCO1/profile.jpg"]);
    post.userid = 1;
    post.commentID[0].push([0,0,1]);
    ...
    post.body = "Cats are cool";
    post.comment.push(["I like cats too"]);
    post.commentname.push([users[0].name]);
    post.commentpic.push(["../MCO1/profile2.png"]);
    post.userid = 0;
    post.commentID.push([1,0,0]);
    post.commentuserID.push([0]);

    post.comment[0].push(["Thats Nice!"]);
    post.commentname[0].push([users[1].name]);
    post.commentpic[0].push(["../MCO1/profile.jpg"]);
    post.commentID[0].push([1,0,1]);
    post.commentuserID[0].push([1]);
    ...
    post.likeCount = 8;
    post.commentCount = 2;
    post.title = "Hello there Im Ysabelle";
    post.body = "Im new to this site";
    post.comment.push(["Hello There!"]);
    post.commentname.push([users[2].name]);
    post.commentpic.push(["../MCO1/profile2.png"]);
    post.userid = 0;
    post.commentID.push([2,0,0]);
    post.commentuserID.push([2]);
    ...
    post.likeCount = 10;
    post.commentCount = 0;
    post.title = "Help with my pc";
    post.body = "IMy pc blue screens when I press the ";
    ...
    post.likeCount = 0;
    post.commentCount = 0;
    post.title = "What to do on sundays!";
    post.body = "Im bored";
    ...
    post.likeCount = 4;
    post.commentCount = 0;
    post.title = "Dogs are cool too!";
    post.body = "Just as cool as cats!";
...
if(localStorage.getItem('post_data_container') == null){
    createTempPosts();
}
...
if(localStorage.getItem('post_data_container')){
    loadposts();
}
